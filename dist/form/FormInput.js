...
};_this.shake=_this.shake.bind(_this);return _this;}_createClass(FormInput,[{key:'componentWillMount',value:function componentWillMount(){this.shakeAnimationValue=new _reactNative.Animated.Value(0);this.props.shake&&this.shake();}},{key:'componentWillReceiveProps',value:function componentWillReceiveProps(nextProps){nextProps.shake&&this.props.shake!==nextProps.shake&&this.shake();}},{key:'focus',value:function focus()
...
this.props,containerStyle=_props.containerStyle,inputStyle=_props.inputStyle,containerRef=_props.containerRef,normalizeFontSize=_props.normalizeFontSize,shake=_props.shake,textInputRef=_props.textInputRef,attributes=_objectWithoutProperties(_props,['containerStyle','inputStyle','containerRef','normalizeFontSize','shake','textInputRef']);
...
{
transform:[{translateX:translateX}]}],__source:{fileName:_jsxFileName,lineNumber:89}},
...
inputStyle&&inputStyle],__source:{fileName:_jsxFileName,lineNumber:99}}))));




}}]);return FormInput;}(_react.Component);
...
shake:_propTypes2.default.oneOfType([
...
color:_colors2.default.grey3})});exports.default=
