...
props.type,name=props.name,size=props.size,color=props.color,iconStyle=props.iconStyle,component=props.component,underlayColor=props.underlayColor,reverse=props.reverse,raised=props.raised,containerStyle=props.containerStyle,reverseColor=props.reverseColor,onPress=props.onPress,onLongPress=props.onLongPress,attributes=_objectWithoutProperties(props,['type','name','size','color','iconStyle','component','underlayColor','reverse','raised','containerStyle','reverseColor','onPress','onLongPress']);
...
android:_elevation2.default.android.two,
web:_elevation2.default.web.two}))});exports.default=
