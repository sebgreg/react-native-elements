...
var _DummyNavButton=require('./DummyNavButton');var _DummyNavButton2=_interopRequireDefault(_DummyNavButton);
...
var _colors=require('../config/colors');var _colors2=_interopRequireDefault(_colors);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function _objectWithoutProperties(obj,keys){var target={};for(var i in obj){if(keys.indexOf(i)>=0)continue;if(!Object.prototype.hasOwnProperty.call(obj,i))continue;target[i]=obj[i];}return target;}
...
props.children,statusBarProps=props.statusBarProps,leftComponent=props.leftComponent,centerComponent=props.centerComponent,rightComponent=props.rightComponent,backgroundColor=props.backgroundColor,outerContainerStyles=props.outerContainerStyles,innerContainerStyles=props.innerContainerStyles,attributes=_objectWithoutProperties(props,['children','statusBarProps','leftComponent','centerComponent','rightComponent','backgroundColor','outerContainerStyles','innerContainerStyles']);
